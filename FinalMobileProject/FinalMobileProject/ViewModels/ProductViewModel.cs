...
namespace FinalMobileProject.ViewModels
{
    ...
    class ProductViewModel
    {
        ...
        public ProductViewModel()
        {
            ...
            FoodList.Add(new Product { Image = "https://cdn.shopify.com/s/files/1/1728/2157/products/05-62587_STEEL_WIDEMOUTH_WATERBOTTLE_32OZ_SMOKYBIRCH_A.jpg?v=1553026837", Title = "Gray Metal Bottle", Price = "19.99", Description = "Add a cool, shiny twist to your welcome drinks with these metal straws! Straw pack, Includes 4 straws and 1 cleaning brush, Reusable, Metal and plastic(brush) and stainless steel(straws), Straw: 20.5cm(L) x 0.6cm(Dia.), Brush: 17.3cm(L), For domestic use only, Clean according to instructions on the care label" });
